...
import kinematics_helpers as kh
import geometry_helpers as gh
import urdf_helpers as uh
# import maker_helpers as mh
...
class GenerateDhParams():
    ...
    def InitializeDhNode(self):
        ...
        self.urdf_file = "mycobot_urdf.urdf"
    ...
    def calculate_dh_params(self):
        ...
        pd_frame = pd.DataFrame(robot_dh_params, columns=['joint', 'parent', 'child', 'd', 'theta', 'a', 'alpha'])
